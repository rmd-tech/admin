...
const EditView = ({
  ...
  // get roles.name of current user
  // gte userInfo from localstorage
  let userInfo ;
  ...
  // get user roles by userInfo.id from userPermissions
  const userPermissionsk = get(userInfo, ['permissions'], []);
  ...
  // get user roles by user.id from userPermissions
